...
;;; Note: Check routine is here, but is currently
;;;       commented-out.  Probably needed in future
;======================================
...
;;; Note: Read routine is here, but is currently
;;;       not needed (log = output-only)
;======================================
